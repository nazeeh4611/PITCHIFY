...
class InvestorController {
    constructor(signupusecase, verifyotpusecase, loginusecase, profileusecase, editprofileusecase, verifyusecase, detailsusecase, modelsusecase, modeldetails, getplanusecase, premiumusecase, reviewusecase, createChatUseCase, MessageUseCase, getReciever, getchatsusecase, googleauthusecase, savemodelusecase, unsavemodelusecase, exclusivemodelusecase) {
        ...
        this.modelsusecase = modelsusecase;
        ...
        this.getReciever = getReciever;
        this.getchatsusecase = getchatsusecase;
        this.googleauthusecase = googleauthusecase;
        this.savemodelusecase = savemodelusecase;
        this.unsavemodelusecase = unsavemodelusecase;
        this.exclusivemodelusecase = exclusivemodelusecase;
    ...
    async signup(req, res, next) {
        ...
        try {
            const investor = await this.signupusecase.execute(firstname, lastname, email, phone, password, confirmpassword, res);
    ...
    async verifyInvestor(req, res, next) {
        try {
    ...
    async getMessageReciever(req, res, next) {
        try {
            const { id } = req.params;
    ...
    async unsavemodel(req, res, next) {
        try {
            const { email, model } = req.body;
    ...
    async exclusivemodel(req, res, next) {
        try {
