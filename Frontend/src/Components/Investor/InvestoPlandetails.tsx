...
const SubscriptionDetails: React.FC<SubscriptionDetailsProps> = ({ investorData, startDate, endDate }) => {
    ...
    <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
      <div className="mb-6">
        ...
        <div className="border rounded-lg p-4">
          <h3 className="text-blue-600 text-md font-bold">{investorData?.name || "Monthly Plan"}</h3>
          <p className="text-sm text-gray-600">{investorData?.description || "30 Days Plan"}</p>
