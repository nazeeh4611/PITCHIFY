    ...
    <div className="w-full max-w-sm mx-auto bg-white rounded-xl shadow-md border border-gray-200 p-4 hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="flex justify-between items-center mb-3">
        <div className="flex items-center">
          ...
          <h2 className="text-lg font-bold text-gray-800">Premium Plan</h2>
        </div>
        <span className="bg-gradient-to-r from-green-400 to-green-500 text-white text-xs px-2 py-0.5 rounded-full font-medium shadow-sm">Active</span>
      </div>
      ...
      <div className="space-y-2 mb-3">
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-sm font-semibold text-indigo-600">{daysRemaining} days remaining</span>
        </div>
        
        <div className="flex justify-between items-center">
          <span className="text-sm text-gray-500 font-medium">Amount</span>
          <span className="text-sm font-semibold text-gray-800">${entrepreneurdata?.price || "19.00"}/month</span>
        </div>
      </div>
      ...
      <div className="mb-3 bg-gray-50 p-3 rounded-lg">
        ...
        <ul className="text-xs space-y-1 text-gray-600">
          <li className="flex items-center">
            <div className="w-4 h-4 flex items-center justify-center bg-indigo-100 text-indigo-600 rounded-full mr-2">
      ...
      <div className="space-y-2">
        <button className="w-full bg-gradient-to-r from-indigo-500 to-indigo-600 text-white font-medium py-1.5 px-4 rounded-lg hover:from-indigo-600 hover:to-indigo-700 transition-all duration-200 text-xs shadow-sm flex justify-center items-center">
